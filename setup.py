...
# Package meta-data.
NAME = 'bruty'
DESCRIPTION = 'National Bathymetric Source module to combine data and export product areas'
URL = 'https://github.com/noaa-ocs-hydrography/bruty'
...
about = {}
if not VERSION:
    with open(os.path.join(here, 'bruty', '__version__.py')) as f:
        exec(f.read(), about)
else:
