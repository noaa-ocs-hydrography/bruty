...
<qgis version="3.28.3-Firenze" styleCategories="Symbology">
  <renderer-v2 enableorderby="1" symbollevels="0" type="RuleRenderer" referencescale="-1" forceraster="0">
    <rules key="{1b1645df-c77c-4f39-80b6-ae0e58b962e7}">
      <rule filter="attribute(@feature, 'combine_code')&lt;=0" description="combine_code has a success code -- REMEMBER this has to be a lower symbol level than the Waiting symbology " symbol="0" key="{5b2673e9-21fe-480a-9c9c-4e8be4d35ca1}" label="Combine Complete"/>
      ...
      <rule filter="attribute(@feature, 'combine_running') is True" symbol="2" key="{ab98925e-ce62-4acf-820d-cdd4bfad04fb}" label="Combining"/>
      <rule filter="if(attribute(@feature, 'combine_request_time')='enc', attribute(@feature, 'enc_request_time'), attribute(@feature, 'combine_request_time')) > attribute(@feature, 'combine_start_time') or if(attribute(@feature, 'combine_request_time')='enc', attribute(@feature, 'enc_request_time'), attribute(@feature, 'combine_request_time')) > attribute(@feature, 'combine_end_time') or (if(attribute(@feature, 'combine_request_time')='enc', attribute(@feature, 'enc_request_time'), attribute(@feature, 'combine_request_time')) is not NULL and (attribute(@feature, 'combine_start_time') is NULL or attribute(@feature, 'combine_end_time') is NULL))" symbol="3" key="{85c743d7-d84b-437f-b815-38d89bc1a97b}" label="Combine Waiting"/>
      <rule filter="attribute(@feature, 'export_code') > 0 or attribute(@feature, 'export_code') is NULL" symbol="4" key="{f5835130-aef8-4ee2-b011-60846c38d2bf}" label="Export Failed"/>
      <rule filter="attribute(@feature, 'export_running') is True" symbol="5" key="{3271a311-bd88-46b3-9776-29b6eab64ebf}" label="Exporting"/>
